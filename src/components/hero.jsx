export default function Hero() {
    return (
        <>
            <section className="grid grid-cols-1 md:grid-cols-2 min-h-screen bg-[#3A3A3A] items-center gap-10 px-6 lg:px-20 py-12">
                <div className="flex flex-col w-full max-w-xl justify-center gap-6 z-10 text-center md:text-left">
                    <h1 className="text-[36px] sm:text-[48px] md:text-[64px] font-extrabold text-[#F3EFF5] leading-tight font-montserrat">
                        Aliados de Última Milla
                    </h1>
                    <p className="text-[#D2D2D2] text-base sm:text-lg leading-relaxed">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 items-center px-6 lg:px-20 min-h-[80vh] bg-[#FFE000] py-12">
                <div className="flex flex-col gap-8 z-10 text-center lg:text-left">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#3A3A3A] max-w-xl mx-auto lg:mx-0">
